...
ARCH="$(uname -m)"
xcrun swiftc -O -target "$ARCH-apple-macos13.0" -parse-as-library Sources/Protocol.swift Sources/HelperSetup.swift Sources/LidDisplay.swift Sources/PowerPolicy.swift Sources/Helper.swift -o "$APP/Contents/Resources/com.yonigo.Owl.helper"
xcrun swiftc -O -target "$ARCH-apple-macos13.0" -parse-as-library Sources/Protocol.swift Sources/OwlIcon.swift Sources/OwlApp.swift -o "$APP/Contents/MacOS/Owl"
